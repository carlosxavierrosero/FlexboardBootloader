...
serialPort = '/dev/ttyUSB0';            %name of serial port

%fclose(instrfind)                       %close all opened ports
delete(instrfind)                       %clean all opened ports
                                        %configuring serial port
s=serial(serialPort);                   %creates a matlab object from the serial port 'COM1' 
...
fclose(s); %closes previous opened serial port
